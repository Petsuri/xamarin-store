...
namespace Store.Interface.Domain
{
    ...
    {
        void Send<TSender, TArgs>(TSender sender, TArgs args) where TSender : class;
        void Send<TSender>(TSender sender, string message) where TSender : class;
        void Send<TSender, TArgs>(TSender sender, string message, TArgs args) where TSender : class;

        void Subscribe<TSender, TArgs>(object subscriber, Action<TSender, TArgs> callback) where TSender : class;
        ...
        void Unsubscribe<TSender, TArgs>(object subscriber) where TSender : class;
